...
class RacecarState:
    ...
    def __init__(self):
        ...
        self.SPEED_TO_ERPM_GAIN = float(
            rospy.get_param("vesc/speed_to_erpm_gain", -1910) ## was 4614.0
        )
        ...
        self.STEERING_TO_SERVO_OFFSET = float(
            rospy.get_param("vesc/steering_angle_to_servo_offset", 0) ## was 0.5304
        )
        self.STEERING_TO_SERVO_GAIN = float(
            rospy.get_param("vesc/steering_angle_to_servo_gain", 1) ## was -1.2135
        )
        ...
        # Width of the car
        self.CAR_WIDTH = float(rospy.get_param("vesc/wheelbase", 0.283)) ## 0.25))
        ...
        self.joint_msg.name = [
            "front_left_wheel_throttle", #   "front_left_wheel_throttle",
            "front_right_wheel_throttle", #  "front_right_wheel_throttle",
            "rear_left_wheel_throttle", #    "back_left_wheel_throttle",
            "rear_right_wheel_throttle", #   "back_right_wheel_throttle",
            "left_steering_hinge_joint", #   "front_left_wheel_steer",
            "right_steering_hinge_joint", #  "front_right_wheel_steer",
        ]
